...
import SubcategoriaSchema from './schemas/SubcategoriaSchema'

const FormSubcategorias = () => {
  ...
  return (
    data
      ...
      : loading ? <Loader /> : <Alert variant="danger" className="text-center">No se encontró la subcategoria</Alert>
  )
}
