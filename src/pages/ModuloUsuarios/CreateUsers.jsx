  ...
  const handleSubmitForm = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setShowAlert(<Message message={json.mesasge} className='alert p-1 alert-danger text-center' />)
      }
    } catch (error) {
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          if (response.ok) {
            ...
            setShowAlert(<Message message={json.message} className='alert p-1 alert-danger text-center' />)
          }
        } catch (error) {
          setShowAlert(<Message message='Error' className='alert alert-danger text-center' />)
        }
