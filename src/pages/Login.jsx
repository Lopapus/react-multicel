                ...
                <form action="#" className="mt-4">
                  ...
                  <div className="form-group mb-4">
                    ...
                    <div className="input-group">
                      ...
                      <input type="text" className="form-control" placeholder="usuario" id="user" autoFocus required />
                    </div>
                  </div>
                  {/* <!-- End of Form --> */}
                  <div className="form-group">
                    ...
                    <div className="form-group mb-4">
                      ...
                      <div className="input-group">
                        ...
                        <input type="password" placeholder="contraseña" className="form-control" id="password" required />
                      </div>
                    </div>
                    {/* <!-- End of Form --> */}
